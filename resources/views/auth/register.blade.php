        ...
        <form action="{{ route('register') }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div class="md:col-span-1">
                ...
                <div class="relative group">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="{{ __('auth.register_text_box_fullname') }}"
            ...
            <div class="md:col-span-1">
                ...
                <div class="relative group">
                    ...
                    <input type="tel" name="phone" value="{{ old('phone') }}" required placeholder="{{ __('auth.register_text_box_phone') }}"
            ...
            <div class="md:col-span-2">
                ...
                <div class="relative group">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required placeholder="{{ __('auth.register_text_box_email') }}"
            ...
            <div class="md:col-span-1" x-data="{ show: false }">
                ...
                <div class="relative group">
                    ...
                    <input :type="show ? 'text' : 'password'" name="password" required placeholder="{{ __('auth.register_text_box_password') }}"
            ...
            <div class="md:col-span-1" x-data="{ show: false }">
                ...
                <div class="relative group">
                    ...
                    <input :type="show ? 'text' : 'password'" name="password_confirmation" required placeholder="{{ __('auth.register_text_box_confirm_password') }}"
