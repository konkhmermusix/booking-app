...
<head>
    ...
    <style>
        @if( !empty($fontRegularData)) @font-face {
        ...
        @endif @if( !empty($fontBoldData)) @font-face {
            font-family: 'KantumruyPro';
...
<body>
    ...
    <table class="header-table">
        <tr>
            <td style="width: 60%;">
                ...
                <div class="hotel-sub">P&T PALACE HOTEL & RESORT</div>
    ...
    <div class="footer">
        ...
        Thank you for choosing P&T Palace Hotel & Resort
    </div>
