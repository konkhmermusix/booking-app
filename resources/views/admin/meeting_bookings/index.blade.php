    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 bg-white dark:bg-gray-900 p-4 rounded-2xl shadow-sm mb-6 border border-gray-100 dark:border-gray-800">
        ...
        <div class="flex flex-wrap items-center gap-2 w-full lg:w-auto">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" @click.outside="open = false" class="h-10 px-3 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all">
                ...
                <div x-show="open" x-cloak x-transition class="absolute right-0 mt-2 w-52 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl shadow-xl z-50 p-1.5 text-xs font-semibold">
                    <a href="{{ route('reportmeetings.index') }}" class="flex items-center gap-2 px-3 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg">
                        <i class="fas fa-chart-line text-blue-500"></i> មើលរបាយការណ៍សាលប្រជុំ
                    </a>
                    <a href="{{ route('reportscreate.index', ['table' => 'meeting_bookings']) }}" class="flex items-center gap-2 px-3 py-2 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 rounded-lg font-bold">
                        <i class="fas fa-sliders-h"></i> បង្កើតរបាយការណ៍តាមថ្ងៃ/ខែ
                    </a>
                    <a href="{{ route('reportmeetings.export-excel') }}" target="_blank" class="flex items-center gap-2 px-3 py-2 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 rounded-lg">
                        <i class="fas fa-file-excel"></i> ទាញយកជា Excel
                    </a>
                    <a href="{{ route('reportmeetings.export-pdf') }}" target="_blank" class="flex items-center gap-2 px-3 py-2 text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/30 rounded-lg">
