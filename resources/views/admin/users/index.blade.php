        ...
        <div class="flex flex-wrap items-center gap-2 w-full lg:w-auto">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" x-cloak x-transition class="absolute right-0 mt-2 w-52 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl shadow-xl z-50 p-1.5 text-xs font-semibold">
                    <a href="{{ route('reportcustomers.index') }}" class="flex items-center gap-2 px-3 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg">
                        <i class="fas fa-chart-line text-blue-500"></i> មើលរបាយការណ៍អតិថិជន
                    </a>
                    <a href="{{ route('reportscreate.index', ['table' => 'customers']) }}" class="flex items-center gap-2 px-3 py-2 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-lg font-bold">
                        <i class="fas fa-sliders-h"></i> បង្កើតរបាយការណ៍តាមថ្ងៃ/ខែ
                    </a>
                    <a href="{{ route('reportcustomers.export-excel') }}" target="_blank" class="flex items-center gap-2 px-3 py-2 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 rounded-lg">
                        <i class="fas fa-file-excel"></i> ទាញយកជា Excel
                    </a>
                    <a href="{{ route('reportcustomers.export-pdf') }}" target="_blank" class="flex items-center gap-2 px-3 py-2 text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/30 rounded-lg">
