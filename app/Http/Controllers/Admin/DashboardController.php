...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $totalRevenueMonth = Booking::whereMonth('created_at', Carbon::now()->month)
        ...
        // $averageRating = Booking::whereNotNull('rating')->avg('rating') ?? 0;
        // $totalReviews = Booking::whereNotNull('rating')->count();
